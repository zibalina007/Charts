    ...
    <script type='text/javascript'>
        $(function (){
            var $model->id = new LinearGauge({
              renderTo: \"$model->id\",
              "; $graph .= $model->colors ? 'colorNumbers: "'.$model->colors[0].'",' : ''; $graph .= '
              '; $graph .= $model->width ? "width: $model->width," : ''; $graph .= $model->height ? "height: $model->height," : ''; $graph .= "
              title: \"$model->title\",
              value: "; $graph .= $model->values ? $model->values[0] : '0'; $graph .= ",
